import { SHOW_SETTINGS, HIDE_SETTINGS, SET_GAME, RESTART_GAME, UPDATE_ELAPSED_TIME, OPEN_CELL, ROTATE_CELL_STATE, HIDE_AUTH, SET_NAME, SHOW_RECORDS, HIDE_RECORDS, UPDATE_RECORDS } from "../actionTypes/control";
